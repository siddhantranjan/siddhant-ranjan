    ...
    return (
        <section id="about" className="py-4">
            <div className="w-full">
                ...
                <div className="w-full flex items-center justify-center mt-12 lg:my-28">
                    <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center w-full lg:w-4/5 lg:space-x-14 lg:h-160">
                        <div className="w-full lg:w-1/2 h-96 md:h-full">
                        ...
                        <div className="w-4/5 mt-12 lg:mt-0 lg:w-1/2 lg:h-full">
                            <div ref={elementRef} className={`flex flex-col items-start justify-between h-full ${elementIsVisible ? "visible animate__animated animate__fadeInRight" : ""}`}>
                                ...
                                <div className="flex flex-col space-y-6 w-full text-lighter mt-10 lg:mt-0">
                                    <div className="w-full flex items-start justify-start">
                                        <span className="w-1/5 md:w-1/2 lg:w-1/4 font-semibold"> Name </span> : Siddhant Ranjan
                                    </div>
                                    <div className="w-full flex items-start justify-start">
                                        <span className="w-1/5 md:w-1/2 lg:w-1/4 font-semibold"> Age </span>
                                        : 25
                                    </div>
                                    <div className="w-full flex items-start justify-start">
                                        <span className="w-1/5 md:w-1/2 lg:w-1/4 font-semibold"> Address </span>
                                        : Bihar, India
                                    </div>
                                    <div className="w-full flex items-start justify-start">
                                        <span className="w-1/5 md:w-1/2 lg:w-1/4 font-semibold"> Phone Number </span>
                                        : +91 8939015117
                                    </div>
                                    <div className="w-full flex items-start justify-start">
                                        <span className="w-1/5 md:w-1/2 lg:w-1/4 font-semibold"> Email </span>
                                        : sidhantranjan31@gmail.com
                                    </div>
                                </div>
                                <button className="px-8 py-2 border border-tertiary rounded-3xl font-bold text-tertiary mt-10 lg:mt-0">Download CV</button>
                            </div>
                        </div>
                    </div>
                </div>
