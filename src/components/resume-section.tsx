        ...
        <section id="resume" className="">
            <div className="w-full">
                ...
                <div className="flex items-center justify-center">
                    <div className="w-3/4 flex items-start justify-between space-x-8 my-28">
                        <div ref={elementRef} className="w-1/2 flex flex-col">
                            <GraduationCap />
                            <h3 className="text-3xl text-lighter">Education:</h3>
                            <div className={`group mt-8 border-2 border-lighter h-52 px-8 pt-8 ${elementIsVisible ? "visible animate__animated animate__fadeInLeft" : ""}`}>
                                <div className="">
                            ...
                            <div className={`group mt-8 border-2 border-lighter h-52 px-8 pt-8 ${elementIsVisible ? "visible animate__animated animate__fadeInLeft animate__delay-1s" : ""}`}>
                                <div className="">
